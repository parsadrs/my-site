...
# ---------------------------------------------
    ...
    try:
        ...
        console.print("Find the average number of orders placed per customer rounded to 3 decimal places.", style="bold green")

        # --- Fill in your SQL query here ---
        answer = '''
        SELECT 
    ROUND( 
        CAST(COUNT(*) AS FLOAT) / (SELECT COUNT(*) FROM Customers), 
        3
